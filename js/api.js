...
function dashboardSummary(){
    ...
    data.forEach(row => {
        ...
        //=====================================
        // KENDALA
        // HANYA STATUS YANG BENAR-BENAR
        // MENGANDUNG KENDALA
        //=====================================

        if(status.includes("KENDALA")){
        ...
        const teknisi = String(
            row.teknisi || ""
        ).trim();

        if(teknisi){

            teknisiSet.add(teknisi);
...
function setDashboardValue(label, value){
